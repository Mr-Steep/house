<div class="overflow-x-auto relative shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
        @foreach($soonBooking as $habitation)
            ...
            @foreach($habitation->booking as $book)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="py-4 px-6">
                        @if($book->confirmed == 1)
                            <form action="{{route('cancel', $book->id)}}" method="post">
                                @csrf
                                <button type="submit" class="font-medium text-red-600 dark:text-red-500 hover:underline">Отменить</button>
